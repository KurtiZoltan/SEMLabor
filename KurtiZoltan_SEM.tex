...
\begin{document}
	...
	\section{Biológiai minta}
		...
		\end{figure}
	\section{Titán minta}
		A titánból készült mintának volt egy lyukacsos része, erről készült \aref{Tiholes}. kép SE módban. Ez a kép jól illusztrálja, hogy SE módban a geometriai információt hogyan érzékeli az elektronmikroszkóp. Látható, hogy az üregek sötétek, ennek az az oka, hogy a kilökődő másodlagos elektronok nagy része az üreg falán landol, nem jut ki a résen, így a másodlagos elektron detektor csak kevés elektront fog detektálni. Hasonló, de kevésbé drasztikusan jelen van ez az effektus lejtők és egyéb geometriai alakzatok esetében is. 
		\begin{figure}[H]
			\centering
